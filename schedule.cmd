...
echo Starting CaribWeather scheduler.
echo Keep this window open. Scheduled alerts run every 15 minutes.
"%PHP_BIN%" artisan schedule:work

if errorlevel 1 (
    echo.
    echo Laravel scheduler did not start. Copy the error above and send it here.
    pause
)
